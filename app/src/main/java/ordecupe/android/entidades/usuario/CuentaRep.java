...
import ordecupe.android.principal.seguridad.ActualizarDatosRep;
import ordecupe.android.principal.seguridad.PrincipalRep;

public class CuentaRep extends Fragment implements View.OnClickListener{
    Button CERRAR, ACT;
    ...
    public void Actualizar(){
        PrincipalRep activity=(PrincipalRep) getActivity();
        ActualizarDatosRep fragment=new ActualizarDatosRep();
